...
__int64 __fastcall sub_18028BEA0(__int64 a1, __int64 a2, double a3) {
    ...
    static auto dont_buff_my_pylon = OriginalCCVar_FindVar(cvarinterface, "dont_buff_my_pylon");
    static auto cl_showfps = OriginalCCVar_FindVar(cvarinterface, "cl_showfps");
    bool isDrawing = cl_showfps->m_Value.m_nValue == 1 && dont_buff_my_pylon->m_Value.m_nValue == 0;
...
void DrawWatermark() {
    ...
    static auto var = OriginalCCVar_FindVar(cvarinterface, "dont_buff_my_pylon");
