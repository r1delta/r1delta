...
void* R1OFactory(const char* pName, int* pReturnCode) {
	...
	if (!strcmp(pName, "VEngineServer022")) {
		...
		static uintptr_t r1ovtable[] = {
			...
			CreateFunction(((void*)CVEngineServer__NullSub1), (void*)engineinterface),
			CreateFunction(((void*)CVEngineServer__NullSub1), (void*)engineinterface),
			CreateFunction(((void*)(uintptr_t)(&CVEngineServer__FuncThatReturnsFF_Stub)), (void*)engineinterface),
			CreateFunction(((void*)(uintptr_t)(&CVEngineServer__FuncThatReturnsFF_Stub)), (void*)engineinterface),
			CreateFunction(((void*)(uintptr_t)(&CVEngineServer__FuncThatReturnsFF_Stub)), (void*)engineinterface),
			CreateFunction(((void*)(uintptr_t)(&CVEngineServer__FuncThatReturnsFF_Stub)), (void*)engineinterface),
			CreateFunction(((void*)(uintptr_t)(&CVEngineServer__FuncThatReturnsFF_Stub)), (void*)engineinterface),
			...
			CreateFunction(((void*)CVEngineServer__NullSub1), (void*)engineinterface),
			CreateFunction(((void*)CVEngineServer__NullSub1), (void*)engineinterface),
			CreateFunction(((void*)CVEngineServer__NullSub1
#else
...
void __fastcall CSquirrelVM__TranslateCall(__int64* a1) {
	static LPCVOID baseAddressDll = (LPCVOID)GetModuleHandleA("launcher.dll");
	static LPCVOID address1 = (LPCVOID)((uintptr_t)(baseAddressDll)+0xC3AF);
	static LPCVOID address2 = (LPCVOID)((uintptr_t)(baseAddressDll)+0xC7C4);
	char value1 = 0x21;
