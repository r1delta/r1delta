...
void* R1OFactory(const char* pName, int* pReturnCode) {
	...
	if (!strcmp(pName, "VEngineServer022")) {
		...
		if (IsDedicatedServer()) {
			...
			CVEngineServer__GetUnknownPlaylistKV4 = r1vtable[132];
			...
			CVEngineServer__UnkFunc65 = r1vtable[132];
			CVEngineServer__UnkFunc66 = r1vtable[132];
			CVEngineServer__UnkFunc67 = r1vtable[132];
			CVEngineServer__UnkFunc68 = r1vtable[132];
			CVEngineServer__UnkFunc69 = r1vtable[132];
			CVEngineServer__FuncThatReturnsFF_12 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__FuncThatReturnsFF_11 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__FuncThatReturnsFF_10 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__FuncThatReturnsFF_9 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__FuncThatReturnsFF_8 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__FuncThatReturnsFF_7 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__FuncThatReturnsFF_6 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__FuncThatReturnsFF_5 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__FuncThatReturnsFF_4 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__FuncThatReturnsFF_3 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__FuncThatReturnsFF_2 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__FuncThatReturnsFF_1 = uintptr_t(&CVEngineServer__FuncThatReturnsFF_Stub);
			CVEngineServer__UnkFunc72 = r1vtable[132];
			CVEngineServer__UnkFunc73 = r1vtable[132];
			CVEngineServer__UnkFunc74 = r1vtable[132];
			CVEngineServer__UnkFunc75 = r1vtable[132];
			CVEngineServer__UnkFunc76 = r1vtable[132];
			...
			CVEngineServer__UnkFunc78 = r1vtable[132];
			CVEngineServer__UnkFunc79 = r1vtable[132];
