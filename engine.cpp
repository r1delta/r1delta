...
#pragma region Member Initialisers

uintptr_t CVEngineServer::NullSub1;
uintptr_t CVEngineServer::ChangeLevel;
uintptr_t CVEngineServer::IsMapValid;
uintptr_t CVEngineServer::GetMapCRC;
uintptr_t CVEngineServer::IsDedicatedServer;
uintptr_t CVEngineServer::IsInEditMode;
uintptr_t CVEngineServer::GetLaunchOptions;
uintptr_t CVEngineServer::PrecacheModel;
uintptr_t CVEngineServer::PrecacheDecal;
uintptr_t CVEngineServer::PrecacheGeneric;
uintptr_t CVEngineServer::IsModelPrecached;
uintptr_t CVEngineServer::IsDecalPrecached;
uintptr_t CVEngineServer::IsGenericPrecached;
uintptr_t CVEngineServer::IsSimulating;
uintptr_t CVEngineServer::GetPlayerUserId;
uintptr_t CVEngineServer::GetPlayerNetworkIDString;
uintptr_t CVEngineServer::IsUserIDInUse;
uintptr_t CVEngineServer::GetLoadingProgressForUserID;
uintptr_t CVEngineServer::GetEntityCount;
uintptr_t CVEngineServer::GetPlayerNetInfo;
uintptr_t CVEngineServer::IsClientValid;
uintptr_t CVEngineServer::PlayerChangesTeams;
uintptr_t CVEngineServer::RequestClientScreenshot;
uintptr_t CVEngineServer::CreateEdict;
uintptr_t CVEngineServer::RemoveEdict;
uintptr_t CVEngineServer::PvAllocEntPrivateData;
uintptr_t CVEngineServer::FreeEntPrivateData;
uintptr_t CVEngineServer::SaveAllocMemory;
uintptr_t CVEngineServer::SaveFreeMemory;
uintptr_t CVEngineServer::FadeClientVolume;
uintptr_t CVEngineServer::ServerCommand;
uintptr_t CVEngineServer::CBuf_Execute;
uintptr_t CVEngineServer::ClientCommand;
uintptr_t CVEngineServer::LightStyle;
uintptr_t CVEngineServer::StaticDecal;
uintptr_t CVEngineServer::EntityMessageBeginEx;
uintptr_t CVEngineServer::EntityMessageBegin;
uintptr_t CVEngineServer::UserMessageBegin;
uintptr_t CVEngineServer::MessageEnd;
uintptr_t CVEngineServer::ClientPrintf;
uintptr_t CVEngineServer::Con_NPrintf;
uintptr_t CVEngineServer::Con_NXPrintf;
uintptr_t CVEngineServer::UnkFunc1;
uintptr_t CVEngineServer::NumForEdictinfo;
uintptr_t CVEngineServer::UnkFunc2;
uintptr_t CVEngineServer::UnkFunc3;
uintptr_t CVEngineServer::CrosshairAngle;
uintptr_t CVEngineServer::GetGameDir;
uintptr_t CVEngineServer::CompareFileTime;
uintptr_t CVEngineServer::LockNetworkStringTables;
uintptr_t CVEngineServer::CreateFakeClient;
uintptr_t CVEngineServer::GetClientConVarValue;
uintptr_t CVEngineServer::ReplayReady;
uintptr_t CVEngineServer::GetReplayFrame;
uintptr_t CVEngineServer::UnkFunc4;
uintptr_t CVEngineServer::UnkFunc5;
uintptr_t CVEngineServer::UnkFunc6;
uintptr_t CVEngineServer::UnkFunc7;
uintptr_t CVEngineServer::UnkFunc8;
uintptr_t CVEngineServer::ParseFile;
uintptr_t CVEngineServer::CopyLocalFile;
uintptr_t CVEngineServer::PlaybackTempEntity;
uintptr_t CVEngineServer::UnkFunc9;
uintptr_t CVEngineServer::LoadGameState;
uintptr_t CVEngineServer::LoadAdjacentEnts;
uintptr_t CVEngineServer::ClearSaveDir;
uintptr_t CVEngineServer::GetMapEntitiesString;
uintptr_t CVEngineServer::GetPlaylistCount;
uintptr_t CVEngineServer::GetUnknownPlaylistKV;
uintptr_t CVEngineServer::GetPlaylistValPossible;
uintptr_t CVEngineServer::GetPlaylistValPossibleAlt;
uintptr_t CVEngineServer::AddPlaylistOverride;
uintptr_t CVEngineServer::MarkPlaylistReadyForOverride;
uintptr_t CVEngineServer::UnknownPlaylistSetup;
uintptr_t CVEngineServer::GetUnknownPlaylistKV2;
uintptr_t CVEngineServer::GetUnknownPlaylistKV3;
uintptr_t CVEngineServer::GetUnknownPlaylistKV4;
uintptr_t CVEngineServer::UnknownMapSetup;
uintptr_t CVEngineServer::UnknownMapSetup2;
uintptr_t CVEngineServer::UnknownMapSetup3;
uintptr_t CVEngineServer::UnknownMapSetup4;
uintptr_t CVEngineServer::UnknownGamemodeSetup;
uintptr_t CVEngineServer::UnknownGamemodeSetup2;
uintptr_t CVEngineServer::IsMatchmakingDedi;
uintptr_t CVEngineServer::UnusedTimeFunc;
uintptr_t CVEngineServer::IsClientSearching;
uintptr_t CVEngineServer::UnkFunc11;
uintptr_t CVEngineServer::IsPrivateMatch;
uintptr_t CVEngineServer::IsCoop;
uintptr_t CVEngineServer::GetSkillFlag_Unused;
uintptr_t CVEngineServer::TextMessageGet;
uintptr_t CVEngineServer::UnkFunc12;
uintptr_t CVEngineServer::LogPrint;
uintptr_t CVEngineServer::IsLogEnabled;
uintptr_t CVEngineServer::IsWorldBrushValid;
uintptr_t CVEngineServer::SolidMoved;
uintptr_t CVEngineServer::TriggerMoved;
uintptr_t CVEngineServer::CreateSpatialPartition;
uintptr_t CVEngineServer::DestroySpatialPartition;
uintptr_t CVEngineServer::UnkFunc13;
uintptr_t CVEngineServer::IsPaused;
uintptr_t CVEngineServer::UnkFunc14;
uintptr_t CVEngineServer::UnkFunc15;
uintptr_t CVEngineServer::UnkFunc16;
uintptr_t CVEngineServer::UnkFunc17;
uintptr_t CVEngineServer::UnkFunc18;
uintptr_t CVEngineServer::UnkFunc19;
uintptr_t CVEngineServer::UnkFunc20;
uintptr_t CVEngineServer::UnkFunc21;
uintptr_t CVEngineServer::UnkFunc22;
uintptr_t CVEngineServer::UnkFunc23;
uintptr_t CVEngineServer::UnkFunc24;
uintptr_t CVEngineServer::UnkFunc25;
uintptr_t CVEngineServer::UnkFunc26;
uintptr_t CVEngineServer::UnkFunc27;
uintptr_t CVEngineServer::UnkFunc28;
uintptr_t CVEngineServer::UnkFunc29;
uintptr_t CVEngineServer::UnkFunc30;
uintptr_t CVEngineServer::UnkFunc31;
uintptr_t CVEngineServer::UnkFunc32;
uintptr_t CVEngineServer::UnkFunc33;
uintptr_t CVEngineServer::UnkFunc34;
uintptr_t CVEngineServer::InsertServerCommand;
uintptr_t CVEngineServer::UnkFunc35;
uintptr_t CVEngineServer::UnkFunc36;
uintptr_t CVEngineServer::UnkFunc37;
uintptr_t CVEngineServer::UnkFunc38;
uintptr_t CVEngineServer::UnkFunc39;
uintptr_t CVEngineServer::UnkFunc40;
uintptr_t CVEngineServer::UnkFunc41;
uintptr_t CVEngineServer::UnkFunc42;
uintptr_t CVEngineServer::UnkFunc43;
uintptr_t CVEngineServer::UnkFunc44;
uintptr_t CVEngineServer::AllocLevelStaticData;
uintptr_t CVEngineServer::UnkFunc45;
uintptr_t CVEngineServer::UnkFunc46;
uintptr_t CVEngineServer::UnkFunc47;
uintptr_t CVEngineServer::Pause;
uintptr_t CVEngineServer::UnkFunc48;
uintptr_t CVEngineServer::UnkFunc49;
uintptr_t CVEngineServer::UnkFunc50;
uintptr_t CVEngineServer::UnkFunc51;
uintptr_t CVEngineServer::UnkFunc52;
uintptr_t CVEngineServer::MarkTeamsAsBalanced_On;
uintptr_t CVEngineServer::MarkTeamsAsBalanced_Off;
uintptr_t CVEngineServer::UnkFunc53;
uintptr_t CVEngineServer::UnkFunc54;
uintptr_t CVEngineServer::UnkFunc55;
uintptr_t CVEngineServer::UnkFunc56;
uintptr_t CVEngineServer::DisconnectClient;
uintptr_t CVEngineServer::UnkFunc58;
uintptr_t CVEngineServer::UnkFunc59;
uintptr_t CVEngineServer::UnkFunc60;
uintptr_t CVEngineServer::UnkFunc61;
uintptr_t CVEngineServer::UnkFunc62;
uintptr_t CVEngineServer::UnkFunc63;
uintptr_t CVEngineServer::NullSub2;
uintptr_t CVEngineServer::UnkFunc64;
uintptr_t CVEngineServer::NullSub3;
uintptr_t CVEngineServer::NullSub4;
uintptr_t CVEngineServer::UnkFunc65;
uintptr_t CVEngineServer::UnkFunc66;
uintptr_t CVEngineServer::UnkFunc67;
uintptr_t CVEngineServer::UnkFunc68;
uintptr_t CVEngineServer::UnkFunc69;
uintptr_t CVEngineServer::FuncThatReturnsFF_12;
uintptr_t CVEngineServer::FuncThatReturnsFF_11;
uintptr_t CVEngineServer::FuncThatReturnsFF_10;
uintptr_t CVEngineServer::FuncThatReturnsFF_9;
uintptr_t CVEngineServer::FuncThatReturnsFF_8;
uintptr_t CVEngineServer::FuncThatReturnsFF_7;
uintptr_t CVEngineServer::FuncThatReturnsFF_6;
uintptr_t CVEngineServer::FuncThatReturnsFF_5;
uintptr_t CVEngineServer::FuncThatReturnsFF_4;
uintptr_t CVEngineServer::FuncThatReturnsFF_3;
uintptr_t CVEngineServer::FuncThatReturnsFF_2;
uintptr_t CVEngineServer::FuncThatReturnsFF_1;
uintptr_t CVEngineServer::GetClientXUID;
uintptr_t CVEngineServer::IsActiveApp;
uintptr_t CVEngineServer::UnkFunc70;
uintptr_t CVEngineServer::Bandwidth_WriteBandwidthStatsToFile;
uintptr_t CVEngineServer::UnkFunc71;
uintptr_t CVEngineServer::IsCheckpointMapLoad;
uintptr_t CVEngineServer::UnkFunc72;
uintptr_t CVEngineServer::UnkFunc73;
uintptr_t CVEngineServer::UnkFunc74;
uintptr_t CVEngineServer::UnkFunc75;
uintptr_t CVEngineServer::UnkFunc76;
uintptr_t CVEngineServer::NullSub5;
uintptr_t CVEngineServer::NullSub6;
uintptr_t CVEngineServer::UpdateClientHashtag;
uintptr_t CVEngineServer::UnkFunc77;
uintptr_t CVEngineServer::UnkFunc78;
uintptr_t CVEngineServer::UnkFunc79;
uintptr_t CVEngineServer::UnkFunc80;
uintptr_t CVEngineServer::UnkFunc81;
uintptr_t CVEngineServer::UnkFunc82;
...
CVEngineServer::CVEngineServer(uintptr_t* r1vtable)
{
	...
	CreateR1OCVEngineServerInterface();
}
