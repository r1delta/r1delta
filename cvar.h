...
#define FCVAR_PERSIST (1<<31)
#ifdef CI
#define FCVAR_PERSIST_MASK ( (1<<31) | FCVAR_ARCHIVE_PLAYERPROFILE | FCVAR_USERINFO | FCVAR_PRINTABLEONLY | FCVAR_HIDDEN )
#else 
#define FCVAR_PERSIST_MASK ( (1<<31) | FCVAR_ARCHIVE_PLAYERPROFILE | FCVAR_USERINFO | FCVAR_PRINTABLEONLY  )
#endif
