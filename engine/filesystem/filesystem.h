...
extern __int64(*HandleOpenRegularFileOriginal)(__int64 a1, __int64 a2, char a3);
...
typedef void (*CPackFileParseDirectoryType)(void* packFile);
extern CPackFileParseDirectoryType CPackFileParseDirectoryOriginal;
