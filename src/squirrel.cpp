...
void RunAutorunScripts(R1SquirrelVM* r1sqvm, const char* prefix) {
	auto FindFirst = (const char*(*)(uintptr_t, const char*, uintptr_t*))(g_CVFileSystem->FindFirst);
	auto FindNext = (const char* (*)(uintptr_t, uintptr_t))(g_CVFileSystem->FindNext);
	auto FindClose = (void(*)(uintptr_t, uintptr_t))(g_CVFileSystem->FindClose);
...
bool GetSQVMFuncs() {
	...
	*/
	...
	// TODO: re-add after implementing the discord client
	/*
	REGISTER_SCRIPT_FUNCTION(
		SCRIPT_CONTEXT_CLIENT,
		"SendDiscordClient",
