...
void SetupHudwarp()
{
	DWORD64 materialSystemBase = (DWORD64)GetModuleHandleW(L"materialsystem_dx11.dll");
...
{
	static DWORD64 enginedllBaseAddress = (DWORD64)(GetModuleHandleW(L"engine.dll"));
...
void SetupHudWarpHooks() {
	DWORD64 clientBaseAddress = (DWORD64)GetModuleHandleW(L"client.dll");
...
void SetupHudWarpVguiHooks() {
	DWORD64 vguimatsurfacedllBaseAddress = (DWORD64)GetModuleHandleW(L"vguimatsurface.dll");
